...
public class addarticletemplate extends Basepage 
{
	...
	@FindBy(xpath="//a[text()=' Add article template']")
	private WebElement articletemplate;
	public addarticletemplate(WebDriver driver) {
		super(driver);
	...
	public void clickaddarticletemplate()
	{
		this.articletemplate.click();
	}
