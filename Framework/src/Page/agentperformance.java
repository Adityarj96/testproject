...
public class agentperformance extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-user fa-stack-1x']")
	private WebElement agentperformance;
	public agentperformance(WebDriver driver) {
		super(driver);
