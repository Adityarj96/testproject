...
public class allarticletemplate extends Basepage 
{
	...
	@FindBy(xpath="//a[text()=' All article template']")
	private WebElement allarticletemplate;
	public allarticletemplate(WebDriver driver) {
		super(driver);
	...
	public void clcikallarticletemplate()
	{
		driver.manage().timeouts().implicitlyWait(120, TimeUnit.SECONDS);
		this.allarticletemplate.click();
	}
}
