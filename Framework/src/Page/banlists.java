...
public class banlists extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-ban fa-stack-1x']")
	private WebElement banlist;
	public banlists(WebDriver driver) {
		super(driver);
