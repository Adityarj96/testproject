...
public class closeticketworkflow extends Basepage 
{
	...
	@FindBy(xpath="/html/body/div/div/section[2]/div[5]/div[2]/div/div/div[6]/div/div/a/span")
	private WebElement closeticketworkflow;
	public closeticketworkflow(WebDriver driver) {
		super(driver);
	 ...
	 public void clicklogin()
		...
		public void closeticketworkflows()
		{
			JavascriptExecutor js = (JavascriptExecutor) driver;
			 js.executeScript("window.scrollBy(0,890)");
			 driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
			 this.closeticketworkflow.click();
		}
