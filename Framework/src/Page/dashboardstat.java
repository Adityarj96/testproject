...
public class dashboardstat extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-dashboard fa-stack-1x']")
	private WebElement dashboard;
    public dashboardstat(WebDriver driver) {
		super(driver);
	 ...
	 public void clicklogin()
		...
		public void clickdashboardstat() {
