...
public class managementreport extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-user-secret fa-stack-1x']")
	private WebElement managementreport;
	public managementreport(WebDriver driver) {
		super(driver);
	...
	public void clickmanagementreport()
	{
		this.managementreport.click();
	}
