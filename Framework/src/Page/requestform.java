...
public class requestform extends Basepage 
{
    ...
    @FindBy(xpath="/html/body/div/div/section[2]/div[4]/div[2]/div/div/div[5]/div/div/a/span/i")
	...
	public requestform(WebDriver driver) {
	 ...
	 public void clicklogin()
		...
		public void requesterform() throws InterruptedException
		{
			
			JavascriptExecutor js = (JavascriptExecutor) driver;
			 js.executeScript("window.scrollBy(0,390)");
			 driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
			 this.requestform.click();
		}
