...
public class slaplans extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-clock-o fa-stack-1x']")
	private WebElement sla;
	public slaplans(WebDriver driver) {
		super(driver);
	...
	public void clicklogin()
		...
		public void clickslaplans() throws InterruptedException
		{
