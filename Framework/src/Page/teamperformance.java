...
public class teamperformance extends Basepage
{
	...
	@FindBy(xpath="/html/body/div/div/section[2]/div[3]/div[2]/div/div/div[3]/div/div/a/span/i")
	private WebElement teamperformance;
	public teamperformance(WebDriver driver) {
		super(driver);
