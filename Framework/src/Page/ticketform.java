...
public class ticketform extends Basepage 
{
	...
	@FindBy(xpath="/html/body/div/div/section[2]/div[4]/div[2]/div/div/div[4]/div/div/a/span/i")
	private WebElement ticketform;
	public ticketform(WebDriver driver) {
		super(driver);
	 ...
	 public void clicklogin()
		...
		public void ticketforms() throws InterruptedException
		{
			JavascriptExecutor js = (JavascriptExecutor) driver;
			 js.executeScript("window.scrollBy(0,390)");
			 Thread.sleep(2000);
			 this.ticketform.click();
		}
