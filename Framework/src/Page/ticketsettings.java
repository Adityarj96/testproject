...
public class ticketsettings extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-ticket fa-stack-1x']")
	private WebElement ticketsettings;
	public ticketsettings(WebDriver driver) {
		super(driver);
