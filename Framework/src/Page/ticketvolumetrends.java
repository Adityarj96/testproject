...
public class ticketvolumetrends extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-calendar fa-stack-1x']")
	private WebElement ticketvolumetrends;
	public ticketvolumetrends(WebDriver driver) {
		super(driver);
	...
	public void clickticketvolumetrends()
	{
		this.ticketvolumetrends.click();
	}
