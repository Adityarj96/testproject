...
public class dashboardunassigned extends Basepage 
{
	...
	@FindBy(xpath="//a[@id='dash']")
	private WebElement dashboard;
	@FindBy(xpath="//span[@class='info-box-icon bg-orange']")
	private WebElement unassigned; 
	public dashboardunassigned(WebDriver driver) {
		super(driver);
