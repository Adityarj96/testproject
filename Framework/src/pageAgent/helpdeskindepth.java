...
public class helpdeskindepth extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-support fa-stack-1x']")
	private WebElement helpdeskindepth;
	public helpdeskindepth(WebDriver driver) {
		super(driver);
	...
	public void helpdeskindepth()
	{
		this.helpdeskindepth.click();
	}
