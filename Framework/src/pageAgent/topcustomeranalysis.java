...
public class topcustomeranalysis extends Basepage 
{
	...
	@FindBy(xpath="//i[@class='fa fa-bank fa-stack-1x']")
	private WebElement topcustomeranalysis;
	public topcustomeranalysis(WebDriver driver) {
		super(driver);
	...
	public void clicktopcustomeranalysis()
	{
		JavascriptExecutor js = (JavascriptExecutor) driver;
		 js.executeScript("window.scrollBy(0,999)");
		 driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
		 this.topcustomeranalysis.click();
	}
