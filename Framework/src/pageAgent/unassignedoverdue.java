...
public class unassignedoverdue extends Basepage 
{
	...
	@FindBy(xpath="//span[text()='Overdue']")
	private WebElement overdue;
	public unassignedoverdue(WebDriver driver) {
		super(driver);
	...
	public void clickunassignedoverdue()
	{
		this.overdue.click();
	}
